...
public class GalleryTests extends BaseUI{
    ...
    public void testSortPictures1(){
        ...
        galleryPage.selectDropDownByText(Locators.SORT_DROP_DOWN,Data.registrationData);
    }
    @Test
    ...
    public void testSortPictures3(){
        mainPage.clickGalleryLink();
        galleryPage.selectDropDownByValue(Locators.SORT_DROP_DOWN,Data.registrationDataValue);
    }
}
